...
const menus: Record<AppRole, MenuItem[]> = {
  admin: [{ icon: 'home', label: '홈', href: '/dashboard' }, { icon: 'students', label: '학생명단관리', href: '/dashboard/students' }, { icon: 'relationships', label: '계정·가족연결', href: '/dashboard/relationships' }, { icon: 'attendance', label: '출석관리', href: '/dashboard/attendance' }, { icon: 'gem', label: '드림보석', href: '/dashboard/points' }, { icon: 'notice', label: '공지게시판', href: '/dashboard/notices' }, { icon: 'accounts', label: '가입승인', href: '/dashboard/accounts' }],
  teacher: [{ icon: 'home', label: '홈', href: '/dashboard' }, { icon: 'students', label: '전체 학생', href: '/dashboard/attendance' }, { icon: 'attendance', label: '출석등록', href: '/dashboard/attendance' }, { icon: 'gem', label: '보석 관리', href: '/dashboard/points' }, { icon: 'notice', label: '공지게시판', href: '/dashboard/notices' }, { icon: 'contact', label: '연락처', href: '/dashboard#contacts' }],
...
const mobileMenus: Record<AppRole, MenuItem[]> = {
  admin: [menus.admin[0], menus.admin[1], menus.admin[3], menus.admin[4], menus.admin[6]],
  teacher: [menus.teacher[0], menus.teacher[1], menus.teacher[2], menus.teacher[3], menus.teacher[4]],
  parent: menus.parent,
